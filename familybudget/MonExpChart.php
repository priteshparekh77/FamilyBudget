        ...
        <div class="box" style="margin-top:15px;">
                ...
                <form action="">
                                   <div class="nav-tabs-custom" id="ExpvsCat">
                                    ...
                                    <li class="pull-left header"><i class="fa fa-inbox"></i>Expense vs Month</li>
                                </ul>
...
$user_id=$_SESSION['user_id'];
 $qur = "select monthname(STR_TO_DATE(expense_date, '%m/%d/%Y'))as month, expense_amount from expense 

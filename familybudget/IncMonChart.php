        ...
        <div class="box" style="margin-top:15px;">
                ...
                <form action="">
                                   <div class="nav-tabs-custom" id="ExpvsCat">
                                    ...
                                    <li class="pull-left header"><i class="fa fa-inbox"></i> Income Vs Month</li>
                                </ul>
...
<?php
 ...
 //echo $user_id;
 $qur = "select monthname(STR_TO_DATE(date, '%m/%d/%Y'))as month, income_amount from income 
